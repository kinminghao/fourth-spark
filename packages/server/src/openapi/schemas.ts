...
export const RepoHealthResponse = z
  .object({
    status: z.string(),
    repoId: z.string().nullable(),
    opencode: z
...
export const ResolveRepoResponse = z
  .object({
    name: z.string(),
    gitUrl: z.string(),
    localPath: z.string(),
...
export const CloneRepoResponse = z
  .object({
    localPath: z.string(),
    name: z.string(),
    gitUrl: z.string(),
...
export const BranchesResponse = z
  .object({
...
export const AgentsMdResponse = z
  .object({
    content: z.string(),
  })
  .meta({ id: "AgentsMdResponse" })

export const SyncIssuesResponse = z
  .object({
    synced: z.number(),
    comments: z.number(),
    tags: z.number(),
...
export const SyncPullsResponse = z
  .object({
    synced: z.number(),
    links: z.number(),
  })
...
export const SessionLinksResponse = z
  .object({
...
export const SessionAllLinksResponse = z
  .record(
    z.string(),
    z.object({
      issues: z.array(
...
export const SessionSnapshotResponse = z
  .object({
    session: z.unknown(),
...
export const MessagesPageResponse = z
  .object({
...
export const SessionFilePreview = z
  .object({
    path: z.string(),
    ext: z.string(),
  })
...
export const IssueCommentWireSchema = z
  .object({
...
export const WorkspaceCleanupResponse = z
  .object({
...
export const TranscribeStatusResponse = z
  .object({
    available: z.boolean(),
  })
  .meta({ id: "TranscribeStatusResponse" })

export const TranscribeResponse = z
  .object({
    text: z.string(),
  })
  .meta({ id: "TranscribeResponse" })

export const CloudStatusResponse = z
  .object({
...
export const CloudTestResponse = z
  .object({
    connected: z.boolean(),
  })
  .meta({ id: "CloudTestResponse" })

const UsageAccount = z
  .object({
    id: z.string(),
    idPrefix: z.string(),
    label: z.string(),
...
export const AuthorizeResponse = z
  .object({
    pendingId: z.string(),
    url: z.string().optional(),
  })
  .catchall(z.unknown())
  .meta({ id: "AuthorizeResponse" })

export const ExchangeResponse = z
  .object({
    ok: z.boolean(),
    reason: z.string().optional(),
  })
  .catchall(z.unknown())
  .meta({ id: "ExchangeResponse" })

export const AnalyticsSummary = z
  .object({
    cost: z.number(),
    tokensInput: z.number(),
    tokensOutput: z.number(),
...
export const ExtractMemoriesResult = z
  .object({
    results: z.array(
      z.object({
        sessionId: z.string(),
...
export const ExportCustomAgentResponse = z
  .object({
    version: z.number(),
...
export const IssueDraftResponse = z
  .object({
    body: z.string(),
  })
  .meta({ id: "IssueDraftResponse" })

export const IssueCreateDraftResponse = z
  .object({
    title: z.string(),
    body: z.string(),
  })
...
export const RuntimeUpdateResponse = z
  .object({
    runtimeType: z.string(),
  })
  .meta({ id: "RuntimeUpdateResponse" })

export const WorktreeUpdateResponse = z
  .object({
    worktreeEnabled: z.boolean(),
  })
  .meta({ id: "WorktreeUpdateResponse" })

export const RepoStatusResponse = z
  .object({
    status: z.string(),
  })
  .meta({ id: "RepoStatusResponse" })

export const AddChildResponse = z
  .object({
    parentId: z.string(),
    childId: z.string(),
  })
...
// repos.ts
export const ResolveRepoBody = z
  .object({
    localPath: z.string().min(1),
  })
  .meta({ id: "ResolveRepoBody" })

export const CloneRepoBody = z
  .object({
...
export const UpdateRuntimeBody = z
  .object({
    runtimeType: z.string().min(1),
  })
  .meta({ id: "UpdateRuntimeBody" })

export const UpdateWorktreeBody = z
  .object({
    enabled: z.boolean(),
  })
...
// settings.ts
export const UpdateSettingBody = z
  .object({
    value: z.string(),
  })
...
// git-hosts.ts
export const CreateGitHostBody = z
  .object({
    host: z.string().min(1),
...
export const UpdateGitHostBody = z
  .object({
...
// custom-agents.ts
export const CreateCustomAgentBody = z
  .object({
    name: z.string().min(1),
...
export const UpdateCustomAgentBody = z
  .object({
    name: z.string().optional(),
    description: z.string().optional(),
...
export const ImportCustomAgentBody = z
  .object({
...
// prompt-fragments.ts
export const CreateFragmentBody = z
  .object({
    name: z.string().min(1),
    content: z.string().optional(),
  })
...
export const UpdateFragmentBody = z
  .object({
    name: z.string().optional(),
    content: z.string().optional(),
    sortOrder: z.number().int().optional(),
...
// agent-memories.ts
export const CreateMemoryBody = z
  .object({
...
export const UpdateMemoryBody = z
  .object({
    content: z.string().optional(),
    category: z.string().optional(),
    importance: z.number().min(0).max(1).optional(),
...
export const ExtractMemoriesBody = z
  .object({
...
// agents-md.ts
export const UpdateGlobalAgentsMdBody = z
  .object({
    content: z.string(),
    runtimeType: z.string().optional(),
  })
...
export const UpdateRepoAgentsMdBody = z
  .object({
    content: z.string(),
  })
...
// usage.ts
export const SwitchAccountBody = z
  .object({
...
// issues/tags.ts
export const SetIssueTagsBody = z
  .object({
